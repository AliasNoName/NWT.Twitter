System.register(['angular2/core', "angular2/common", "../../Model/Hashtag", "../../Model/User", "../../Model/Tweet", "../../Model/Comment", "../Trends/Trends", "../UserInfo/UserInfo", "../UsersFollowingList/UsersFollowingList", "../Search/Search", "../../Pipes/ContainsPipeUsers"], function(exports_1) {
    ...
    var core_1, common_1, Hashtag_1, User_1, Tweet_1, Comment_1, Trends_1, UserInfo_1, UsersFollowingList_1, Search_1, ContainsPipeUsers_1;
    var Following;
    return {
        setters:[
            function (core_1_1) {
