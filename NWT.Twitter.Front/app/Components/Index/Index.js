System.register(["angular2/core", "../../Model/Hashtag", "../../Model/Tweet", "../../Model/User", "../TweetList/TweetsList", "../Trends/Trends", "../UserInfo/UserInfo", "../NewTweet/NewTweet", "../Search/Search", "../../Pipes/ContainsPipe"], function(exports_1) {
    ...
    var core_1, Hashtag_1, Tweet_1, User_1, TweetsList_1, Trends_1, UserInfo_1, NewTweet_1, Search_1, ContainsPipe_1;
    var Index;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            Index = (function () {
                ...
                Index.prototype.onNewTweetPublish = function (data) {
                    this.tweets.unshift(new Tweet_1.Tweet(this.currentUser, new Date(), data));
                };
